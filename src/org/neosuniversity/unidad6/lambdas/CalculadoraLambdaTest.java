...
public class CalculadoraLambdaTest {
    ...
    public static void main(String[] args) {
        ...
        calculadora1 =  CalculadoraLambdaTest.executeOperationWithValidation(calculadora1);
        calculadora2 =  CalculadoraLambdaTest.executeOperationWithValidation(calculadora2);
        //calculadora3 =  CalculadoraTest.executeOperation(calculadora3);
        calculadora3 =  CalculadoraLambdaTest.executeOperationWithValidation(calculadora3);
